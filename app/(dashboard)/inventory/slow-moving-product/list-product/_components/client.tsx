          ...
          <div className="w-full p-4 rounded-md border border-sky-400/80 overflow-hidden">
            <ScrollArea>
              <div className="flex w-full px-5 py-3 bg-sky-100 rounded text-sm gap-4 font-semibold items-center hover:bg-sky-200/80">
                ...
                <p className="min-w-72 w-full">Product Name</p>
              ...
              {Array.from({ length: 5 }, (_, i) => (
                ...
                >
                  ...
                  <p className="min-w-72 w-full whitespace-pre-wrap">
                    MESIN SPEDOMETER VARIO 160
                  </p>
                  <p className="w-44 flex-none whitespace-pre-wrap">FASHION</p>
                  <p className="w-32 flex-none whitespace-pre-wrap">
                    {formatRupiah(74400)}
                  </p>
                  <div className="w-28 flex-none">
                    <Badge className="rounded w-20 px-0 justify-center text-black font-normal capitalize bg-red-400 hover:bg-red-400">
                      Slow Moving
                    </Badge>
                  </div>
