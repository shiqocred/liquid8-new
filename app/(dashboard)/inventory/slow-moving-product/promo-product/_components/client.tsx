        ...
        <div className="flex flex-col w-full gap-4">
          <div className="flex gap-2 items-center w-full justify-between">
            <Input
              ...
              placeholder="Search..."
            />
            <Link href="/inventory/slow-moving-product/promo-product/create">
              ...
              {Array.from({ length: 5 }, (_, i) => (
                ...
                >
                  ...
                  <p className="w-52 flex-none overflow-hidden text-ellipsis">
                    ...
                    Corporis enim officiis ipsum illo harum, facere aut magni
                    maxime voluptatibus adipisci.
                  </p>
