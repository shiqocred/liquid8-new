    ...
    <div className="flex flex-col items-start bg-gray-100 w-full relative px-4 gap-4 py-4">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbLink href="/inventory/pallet">Pallet</BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
      ...
      <div className="w-full flex gap-2 justify-start items-center pt-2 pb-1 mb-1 border-b border-gray-500">
        <Link href="/inventory/pallet">
          <Button className="w-9 h-9 bg-transparent hover:bg-white p-0 shadow-none">
            <ArrowLeft className="w-5 h-5 text-black" />
          </Button>
        </Link>
        <h1 className="text-2xl font-semibold">Detail Pallet</h1>
      </div>
        ...
        <div className="w-full flex items-center">
          <div className="flex flex-col w-full">
            <div className="flex items-center gap-4">
              ...
              <Badge className="bg-sky-300 hover:bg-sky-300 text-xs font-normal text-black rounded-full py-0.5">
                TOYS HOBBIES (&gt;700)
              </Badge>
            </div>
